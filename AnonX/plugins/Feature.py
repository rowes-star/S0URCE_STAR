...
@app.on_message(
    command(["مميزات","مميزات ستار"])
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس ستار ميوزك\n
⩹━★⊷⌯⌞ sᴏᴜʀᴄᴇ sтᴀʀ ⌝⌯⊶★━⩺
            ...
            [
                [
                    InlineKeyboardButton(
                        "★⌞ sᴏᴜʀᴄᴇ sтᴀʀ ⌝⚡", url=f"https://t.me/S0URCE_STAR"),                        
                 ],[
                InlineKeyboardButton(
